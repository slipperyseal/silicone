...
public class RequestScope {
    ...
    private boolean hadSessionClass;
    ...
    public boolean hadSessionClass() {
        return hadSessionClass;
    }

    public void hadSessionClass(boolean hadSessionClass) {
        this.hadSessionClass = hadSessionClass;
    }
}
